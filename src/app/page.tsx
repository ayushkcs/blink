  ...
  return (
    <div className="landing">
        ...
        <div className="features-inner">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p className="feature-desc">
                PDF, PNG, JPG, GIF, ZIP, MP4 — send literally any file format. No restrictions, no compression.
              </p>
            </div>
            <div className="feature-card">
      ...
      <footer className="landing-footer">
        <p>
          Built with ❤️ using WebRTC · <a href="https://github.com">Open Source</a> · Files never leave your browser
        </p>
      </footer>
    </div>
  );
